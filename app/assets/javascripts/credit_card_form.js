...
$(document).ready(function() 
{
  ...
  // Function to handle submission of form and intercept the default event
  ...
  // Call plan change handler so the plan is set correctly the drop down when the page loads
